    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td><a href="#" data-api='["switchbot-command", "-d", "C70C0516C0C7", "-c", "turnOn"]'>On</a></td>
          <td>&nbsp;</td>
          <td><a href="#" data-api='["switchbot-command", "-d", "C70C0516C0C7", "-c", "turnOff"]'>Off</a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><a href="#" data-api='["catt","-d","host:nest","volumeup"]'>+</a></td>
          <td><a href="#" data-api='["catt","-d","host:nest","volumedown"]'>-</a></td>
          <td><a href="#" data-api='["catt","-d","host:nest","stop"]'>Off</a></td>
        </tr>
        <tr>
          <td id="TW">Tatami WiFi</td>
          <td><a href="#" data-api='["catt","-d","host:tatami","volumeup"]'>+</a></td>
          <td><a href="#" data-api='["catt","-d","host:tatami","volumedown"]'>-</a></td>
          <td><a href="#" data-api='["catt","-d","host:tatami","stop"]'>Off</a></td>
        </tr>
        <tr>
          <td id="CC">TV</td>
          <td><a href="#" data-api='["catt","-d","host:tv","volumeup"]'>+</a></td>
          <td><a href="#" data-api='["catt","-d","host:tv","volumedown"]'>-</a></td>
          <td><a href="#" data-api='["catt","-d","host:tv","stop"]'>Off</a></td>
        </tr>
        <tr>
